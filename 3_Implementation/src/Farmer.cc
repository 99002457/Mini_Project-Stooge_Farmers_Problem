...
Farmer::Farmer():Farmer_Id(0),Farmer_work(""),income(0.0),savings(0.0),CoverCropCost(0.0) {}
Farmer::Farmer(int id,string work,double in,double sav,double ccc) : Farmer_Id(id),Farmer_work(work),income(in),savings(sav),CoverCropCost(ccc) {}
